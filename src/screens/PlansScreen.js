...
function PlansScreen() {
  ...
  const loadCheckout = async (priceId) => {
    ...
    docRef.onSnapshot(async (snapshot) => {
      ...
      if (sessionId) {
        // We have a session, let's redirect to checkout into stripe
        const stripe = await loadStripe(
          "pk_test_51HdbRJITlxwxRaguwY34ROtdYLAjtgcszq2fHUgl0YIlmRHyTQo9etnR6JcHuBf7lQMQIqnUe0FVv9l1MYmn4Pe000da5NDZ1v"
        );
